...
- Functions that call Stripe APIs have all their mandatory arguments provided in the type signature. Optional arguments are added using the withValue functions and joined with '<>'
-}
module Stripey (
  ignoreThis
) where
